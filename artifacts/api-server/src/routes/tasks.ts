...
router.get("/tasks", async (req: any, res: any): Promise<void> => {
...
router.post("/tasks", async (req: any, res: any): Promise<void> => {
...
router.get("/tasks/:id", async (req: any, res: any): Promise<void> => {
...
router.patch("/tasks/:id", async (req: any, res: any): Promise<void> => {
...
router.delete("/tasks/:id", async (req: any, res: any): Promise<void> => {
